...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}[
        W/.style={circle, draw=blue!60, fill=blue!10, very thick, minimum size=5mm, font=\small},
        J/.style={circle, draw=red!60, fill=red!10, very thick, minimum size=5mm, font=\small},
...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}[
        neutral/.style={circle, draw=black!60, fill=black!10, very thick, minimum size=5mm, font=\small},
        W/.style={circle, draw=blue!60, fill=blue!10, very thick, minimum size=5mm, font=\small},
        J/.style={circle, draw=red!60, fill=red!10, very thick, minimum size=5mm, font=\small},
        node distance=0.2cm and 3cm
    ]
